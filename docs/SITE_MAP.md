...
章二 编辑我的作品     my-works.html（V26 功能按键 → 历史作品全集）
  ├─ 筛选：全部 / 已发布 / 草稿·待续写 / 审核中 / 已下架 / 角色·道具
  ├─ 已发布 → 续写 / 收费 / 数据 / 预览
  ├─ 草稿 → 继续续写（直达 work-editor.html?w=<id>）
  └─ 上传新作品 / 创建新作品
章二·附 灵境工坊·工作台 workshop.html（V26 自创作页迁入：编辑器/AI辅助/大纲/逐章/收费/封面/发布）
